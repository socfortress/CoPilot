				...
				<template #dropdown>
					<el-dropdown-menu>
						<el-dropdown-item command="/profile">
							<i class="mdi mdi-account-outline mr-10"></i>
							Profile
						</el-dropdown-item>
						<el-dropdown-item command="/calendar">
							<i class="mdi mdi-calendar mr-10"></i>
							Calendar
						</el-dropdown-item>
						<el-dropdown-item command="/contacts">
							<i class="mdi mdi-account-multiple-outline mr-10"></i>
							Contacts
						</el-dropdown-item>
...
.toolbar {
	...
	.notification-icon {
		...
		margin-left: 20px;
		//color: #aab7c5;
		color: transparentize(var(--fg-color), 0.7);
		@include text-bordered-shadow();
