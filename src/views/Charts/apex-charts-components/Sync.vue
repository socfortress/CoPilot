<template>
	<CardCodeExample title="Sync">
		<div class="flex flex-col">
			...
			<apexchart type="area" height="160" :options="chartOptionsArea1" :series="seriesArea1"></apexchart>
...
const card = ref(null)
const chart1 = ref<VueApexChartsComponent>()
const chart2 = ref<VueApexChartsComponent>()
