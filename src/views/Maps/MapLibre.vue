	...
	<div class="page">
		...
		<n-card>
			<div style="height: 60vh; width: 100%">
				<mgl-map ref="map" :center="center" :zoom="zoom" :attribution-control="false" :language="currentLocale">
...
import type { ValidLanguages, StyleSwitchItem } from "vue-maplibre-gl"
import { type LngLatLike, type LineLayerSpecification, type CircleLayerSpecification } from "maplibre-gl"
...
const currentLocale = computed(() => useLocalesStore().locale as ValidLanguages)
...
onMounted(() => {
	setTimeout(() => {
		...
		setTimeout(() => {
			if (map.language) {
				map.language = currentLocale.value
			}
		}, 500)
	}, 500)
})
