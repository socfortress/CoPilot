...
Beyond the shared catalog, you can author your own Graylog detection rules inside CoPilot — validated against a schema and linter, backtested against your real data, and published to a GitHub repository you control, where they merge back into this same catalog with a **Custom** badge.

See [Custom detection rules](/power-features/copilot-searches-custom-rules).

---

## Related resources

- [Custom detection rules](/power-features/copilot-searches-custom-rules) — author, validate, backtest and publish your own rules
