...
from app.incidents.routes.customer_report import customer_reports_router
...
router.include_router(customer_reports_router, prefix="/incidents/customer_reports", tags=["incidents-customer-reports"])
