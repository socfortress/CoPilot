...
router.include_router(dfir_iris_alerts_router, prefix="/soc/alerts", tags=["soc-alerts"])
router.include_router(dfir_iris_assets_router, prefix="/soc/assets", tags=["soc-assets"])
