...
@sysmon_config_router.get("", response_model=SysmonConfigListResponse, dependencies=[Security(AuthHandler().require_any_scope("admin"))])
...
@sysmon_config_router.get("/{customer_code}", dependencies=[Security(AuthHandler().require_any_scope("admin"))])
