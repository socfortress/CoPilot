...
class Office365ThreatIntelAlertBase(BaseModel):
...
class Office365ThreatIntelAlertRequest(Office365ThreatIntelAlertBase):
    ...
    data_office365_SenderIp: Optional[str] = Field(
        None,
        description="Sender IP of the alert",
    )
    data_office365_Recipients: Optional[str] = Field(
        None,
        description="Recipients of the alert",
    )
    data_office365_EventDeepLink: Optional[str] = Field(
        None,
        description="Event Deep Link of the alert",
    )
    data_office365_ThreatsAndDetectionTech: Optional[str] = Field(
        None,
        description="Threats and Detection Techniques of the alert",
    )
...
class Office365ThreatIntelAlertResponse(BaseModel):
    success: bool
    message: str
...
class IrisAlertContext(BaseModel):
    ...
    detection_type: Optional[str] = Field(
        None,
        description="Detection type of the alert",
        example="Malware",
    )
    event_link: Optional[str] = Field(
        None,
        description="Event link of the alert",
