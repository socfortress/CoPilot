...
class Condition(SQLModel, table=True):
    ...
    event_order_id: int = Field(default=None, foreign_key="custom_alert_creation_event_order.id")
...
class EventOrder(SQLModel, table=True):
    ...
    id: int = Field(default=None, primary_key=True)
    alert_creation_settings_id: int = Field(default=None, foreign_key="custom_alert_creation_settings.id")
...
class AlertCreationEventConfig(SQLModel, table=True):
    ...
    event_order_id: Optional[int] = Field(default=None, foreign_key="custom_alert_creation_event_order.id")
