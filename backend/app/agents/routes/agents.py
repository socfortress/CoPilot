...
from app.agents.schema.agents import AgentsResponse, SyncedAgentsResponse, SyncedAgent, AgentModifyResponse, OutdatedWazuhAgentsResponse, OutdatedVelociraptorAgentsResponse, AgentUpdateCustomerCodeBody, AgentUpdateCustomerCodeResponse
from app.agents.wazuh.schema.agents import WazuhAgent, WazuhAgentsList, WazuhAgentVulnerabilitiesResponse
from app.agents.services.sync import sync_agents
from app.agents.services.modify import mark_agent_criticality, delete_agent_db, delete_agent_wazuh
from app.agents.wazuh.services.vulnerabilities import collect_agent_vulnerabilities
from app.agents.services.status import get_outdated_agents_wazuh, get_outdated_agents_velociraptor
...
@agents_router.get("/velociraptor/outdated", response_model=OutdatedVelociraptorAgentsResponse, description="Get all outdated Velociraptor agents")
...
@agents_router.put("/{agent_id}/update-customer-code", response_model=AgentUpdateCustomerCodeResponse, description="Update agent customer code")
