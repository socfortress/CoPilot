...
def get_streams() -> GraylogStreamsResponse:
    ...
    if streams_collected["success"]:
        ...
        return GraylogStreamsResponse(streams=streams_list, success=True, message="Streams collected successfully", total=streams_collected["data"]["total"])
    else:
