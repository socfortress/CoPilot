...
from app.connectors.graylog.schema.events import (
    EventDefinition, GraylogEventDefinitionsResponse, Event, GraylogAlertsResponse, AlertQuery, Alerts, Context, Parameters, AlertEvent
)
...
def get_event_definitions() -> GraylogEventDefinitionsResponse:
    ...
    if event_definitions_collected["success"]:
        ...
        return GraylogEventDefinitionsResponse(event_definitions=event_definitions_list, success=True, message="Event definitions collected successfully")
    else:
