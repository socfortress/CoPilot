!(function (e, t) {
    ...
    return function (e) {
        e.multiLanguage = function () {
            for (
                var t = Array.prototype.slice.call(arguments), i = t.join("-"), r = "", n = [], s = [], p = 0;
                p < t.length;
                ++p
            )
                "en" == t[p]
                    ? ((r += "\\w"), n.unshift(e.stopWordFilter), n.push(e.stemmer), s.push(e.stemmer))
            ...
            return (
                ...
                function () {
                    this.pipeline.reset(),
                        ...
                        this.searchPipeline &&
                            (this.searchPipeline.reset(), this.searchPipeline.add.apply(this.searchPipeline, s))
                }
            )
        }
    }
