!(function (e, r) {
    ...
    return function (e) {
        ...
        ;(e.sa = function () {
            this.pipeline.reset(),
                this.pipeline.add(e.sa.trimmer, e.sa.stopWordFilter, e.sa.stemmer),
                this.searchPipeline && (this.searchPipeline.reset(), this.searchPipeline.add(e.sa.stemmer))
        }),
            (e.sa.wordCharacters = "ऀ-ःऄ-एऐ-टठ-यर-िी-ॏॐ-य़ॠ-९॰-ॿ꣠-꣱ꣲ-ꣷ꣸-ꣻ꣼-ꣽꣾ-ꣿᆰ0-ᆰ9"),
            (e.sa.trimmer = e.trimmerSupport.generateTrimmer(e.sa.wordCharacters)),
            e.Pipeline.registerFunction(e.sa.trimmer, "trimmer-sa"),
            (e.sa.stopWordFilter = e.generateStopWordFilter(
        ...
        r.init(),
            (e.sa.tokenizer = function (t) {
                ...
                return r.cut(i).split("|")
            }),
            e.Pipeline.registerFunction(e.sa.stemmer, "stemmer-sa"),
            e.Pipeline.registerFunction(e.sa.stopWordFilter, "stopWordFilter-sa")
    }
})
