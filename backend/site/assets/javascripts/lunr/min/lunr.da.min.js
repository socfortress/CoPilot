    ...
    return function (e) {
        ...
        ;(e.da = function () {
            this.pipeline.reset(),
                ...
                this.searchPipeline && (this.searchPipeline.reset(), this.searchPipeline.add(e.da.stemmer))
        }),
            (e.da.wordCharacters =
                ...
                var r = e.stemmerSupport.Among,
                    ...
                    n = new (function () {
                            ...
                            f.cursor >= d &&
                                ...
                                f.find_among_b(l, 4)
                                    ? ((f.bra = f.cursor),
                                      (f.limit_backward = e),
                                      (f.cursor = f.limit - r),
                                      f.cursor > f.limit_backward && (f.cursor--, (f.bra = f.cursor), f.slice_del()))
                                    : (f.limit_backward = e))
                        }
                        function s() {
                            var e,
                            ...
                            if (
                                ((f.ket = f.cursor),
                                f.eq_s_b(2, "st") && ((f.bra = f.cursor), f.eq_s_b(2, "ig") && f.slice_del()),
                                (f.cursor = f.limit - n),
                                f.cursor >= d &&
                                    ((r = f.limit_backward),
                                    (f.limit_backward = d),
                                ...
                                switch (((f.bra = f.cursor), e)) {
                                    case 1:
                                        f.slice_del(), (i = f.limit - f.cursor), t(), (f.cursor = f.limit - i)
                                        break
                                    case 2:
                                        f.slice_from("løs")
                                }
                        ...
                        var a,
                            ...
                            l = [new r("gd", -1, -1), new r("dt", -1, -1), new r("gt", -1, -1), new r("kt", -1, -1)],
                            m = [
                                new r("ig", -1, 1),
                                new r("lig", 0, 1),
                                new r("elig", 1, 1),
