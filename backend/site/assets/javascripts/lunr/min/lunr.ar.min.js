            ...
            (e.ar.stemmer = (function () {
                ...
                return (
                    ...
                    (e.cleanWord = function () {
                        ...
                        return (e.word = e.word.replace(new RegExp("ـ", "g"), "")), !!r.test("")
                    }),
                    ...
                    (e.removeEndTaa = function () {
                        return (
                            !(e.word.length > 2) ||
                            ((e.word = e.word.replace(/[\u0627]$/, "")), (e.word = e.word.replace("ة", "")), !1)
                        )
                    }),
                    (e.removeStartWaw = function () {
                        return (
                            e.word.length > 3 && "و" == e.word[0] && "و" == e.word[1] && (e.word = e.word.slice(1)), !1
                        )
                    }),
                    ...
                    (e.wordCheck = function () {
                        for (
                            var r = (e.word, [e.removeSuf432, e.removeSuf1, e.removePre1]), t = 0, c = !1;
                        ...
                        for (t = 0; 6 == e.word.length && !e.result && t < l.length; ) l[t](), t++
                        var n = [e.checkPattern53, e.removeSuf432, e.removeSuf1, e.removePre1, e.checkPattern54]
                        for (t = 0; 5 == e.word.length && !e.result && t < n.length; ) n[t](), t++
                        var o = [e.checkPattern43, e.removeSuf1, e.removePre1, e.removeSuf432]
                        for (t = 0; 4 == e.word.length && !e.result && t < o.length; ) o[t](), t++
                        return !0
                    }),
