    ...
    return function (e) {
        ...
        ;(e.no = function () {
            this.pipeline.reset(),
                ...
                this.searchPipeline && (this.searchPipeline.reset(), this.searchPipeline.add(e.no.stemmer))
        }),
            (e.no.wordCharacters =
                    ...
                    i = new (function () {
                                    ...
                                    case 2:
                                        ;(n = w.limit - w.cursor),
                                            w.in_grouping_b(c, 98, 122)
                                                ? w.slice_del()
                                                : ((w.cursor = w.limit - n),
                                                  w.eq_s_b(1, "k") && w.out_grouping_b(d, 97, 248) && w.slice_del())
                                        break
                                    case 3:
                                        w.slice_from("er")
                                }
                        ...
                        function o() {
                            ...
                            w.cursor >= a &&
                                ...
                                e
                                    ? ((w.bra = w.cursor), (w.limit_backward = r), 1 == e && w.slice_del())
                                    : (w.limit_backward = r))
                        }
                        var s,
                            a,
