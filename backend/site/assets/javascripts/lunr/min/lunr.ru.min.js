    ...
    return function (e) {
        ...
        ;(e.ru = function () {
            this.pipeline.reset(),
                ...
                this.searchPipeline && (this.searchPipeline.reset(), this.searchPipeline.add(e.ru.stemmer))
        }),
                ...
                var n = e.stemmerSupport.Among,
                    ...
                    t = new (function () {
                            ...
                            if (((W.ket = W.cursor), (r = W.find_among_b(e, n)))) {
                                switch (((W.bra = W.cursor), r)) {
                                    case 1:
                                        if (
                                            ((t = W.limit - W.cursor),
                                            !W.eq_s_b(1, "а") && ((W.cursor = W.limit - t), !W.eq_s_b(1, "я")))
                                        )
                                            return !1
                                    case 2:
                                        W.slice_del()
                        ...
                        function s(e, n) {
                            ...
                            return (
                                (W.ket = W.cursor),
                                !!(r = W.find_among_b(e, n)) && ((W.bra = W.cursor), 1 == r && W.slice_del(), !0)
                            )
                        }
                        function c() {
                            return s(g, 26)
                        ...
                        function p() {
                            var e
                            ;(W.ket = W.cursor),
                                (e = W.find_among_b(F, 2)) && ((W.bra = W.cursor), i() && 1 == e && W.slice_del())
                        }
                        function d() {
                            var e
                                ...
                                return (
                                    ...
                                    !(W.cursor < b) &&
                                        ...
                                        o() ||
                                            ((W.cursor = W.limit),
                                            f() || (W.cursor = W.limit),
                                            m() || ((W.cursor = W.limit), l() || ((W.cursor = W.limit), a()))),
                                        (W.cursor = W.limit),
                                        (W.ket = W.cursor),
                                        W.eq_s_b(1, "и") ? ((W.bra = W.cursor), W.slice_del()) : (W.cursor = W.limit),
                                        p(),
                                        (W.cursor = W.limit),
                                        d(),
                                        !0)
