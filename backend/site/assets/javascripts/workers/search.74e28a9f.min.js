...
;(() => {
    ...
    var Z = Math.pow,
        J = (t, e, r) => (e in t ? U(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r)),
        A = (t, e) => {
    ...
    var Le = (t, e, r, n) => {
        if ((e && typeof e == "object") || typeof e == "function")
            for (let i of Te(e))
                !X.call(t, i) && i !== r && U(t, i, { get: () => e[i], enumerable: !(n = ve(e, i)) || n.enumerable })
        return t
    }
    var we = (t, e, r) => (
        (r = t != null ? me(Qe(t)) : {}),
        Le(e || !t || !t.__esModule ? U(r, "default", { value: t, enumerable: !0 }) : r, t)
    )
    var B = (t, e, r) =>
        new Promise((n, i) => {
            var s = c => {
                ...
                for (var n = e.toString().toLowerCase(), i = n.length, s = [], o = 0, a = 0; o <= i; o++) {
                    ...
                    if (c.match(t.tokenizer.separator) || o == i) {
                        if (u > 0) {
                            ...
                            ;(l.position = [a, u]), (l.index = s.length), s.push(new t.Token(n.slice(a, o), l))
                        }
                        a = o + 1
                    }
                }
...
`,
             ...
             */ ;(t.stemmer = (function () {
                var e = {
                    ...
                    M = function (h) {
                        ...
                        if (((p = P), p.test(h))) {
                            var Q = p.exec(h)
                            ;(S = Q[1]), (p = f), (T = v), (O = $), (p.test(S) || (T.test(S) && !O.test(S))) && (h = S)
                        }
                        return (
                            (p = z),
                            (T = f),
                        ...
                        if (s.editsRemaining != 0) {
                            ...
                            if (s.str.length > 1) {
                                ...
                                g in s.node.edges
                                    ...
                                    i.push({ node: f, editsRemaining: s.editsRemaining - 1, str: l + s.str.slice(2) })
                            }
                        }
                    }
                    return n
                            ...
                            for (var l = s[u], g = 0; g < c; g++) {
                                ...
                                if (f == l || l == "*") {
                                    ...
                                    f in n.output.edges
                                        ...
                                        : ((d = new t.TokenSet()), (d.final = x), (n.output.edges[f] = d)),
                ...
                (t.Index.prototype.query = function (e) {
                    ...
                    for (var c = 0; c < r.clauses.length; c++) {
                        var u = r.clauses[c],
                            l = null,
                            g = t.Set.empty
                        u.usePipeline ? (l = this.pipeline.runString(u.term, { fields: u.fields })) : (l = [u.term])
                                ...
                                for (
                                    ...
                                    if (
                                        (u.presence == t.Query.presence.REQUIRED &&
                                            ((g = g.union(N)), o[y] === void 0 && (o[y] = t.Set.complete)),
                    ...
                    for (var M = t.Set.complete, I = t.Set.empty, c = 0; c < this.fields.length; c++) {
                        var y = this.fields[c]
                    ...
                    for (var c = 0; c < h.length; c++) {
                        ...
                        if (M.contains(p) && !I.contains(p)) {
                            var T = this.fieldVectors[L],
                                ...
                                F
                            if ((F = k[p]) !== void 0) (F.score += O), F.matchData.combine(n[L])
                            else {
                ...
                (t.Builder.prototype.add = function (e, r) {
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        for (var v = 0; v < l.length; v++) {
                            var m = l[v]
                            if ((f[m] == null && (f[m] = 0), (f[m] += 1), this.invertedIndex[m] == null)) {
                                var x = Object.create(null)
                                ;(x._index = this.termIndex), (this.termIndex += 1)
                                for (var d = 0; d < i.length; d++) x[i[d]] = Object.create(null)
                                this.invertedIndex[m] = x
                            }
                            this.invertedIndex[m][o][n] == null && (this.invertedIndex[m][o][n] = Object.create(null))
                            for (var y = 0; y < this.metadataWhitelist.length; y++) {
                                var b = this.metadataWhitelist[y],
                                    E = m.metadata[b]
                                this.invertedIndex[m][o][n][b] == null && (this.invertedIndex[m][o][n][b] = []),
                    ...
                    for (
                        ...
                        for (
                            ...
                            var d = g[x],
                                ...
                                R
                            i[d] === void 0
                                ? ((E = t.idf(this.invertedIndex[d], this.documentCount)), (i[d] = E))
                                : (E = i[d]),
                                (w =
                                    (E * ((this._k1 + 1) * y)) /
                                    (this._k1 * (1 - this._b + this._b * (c / this.averageFieldLength[a])) + y)),
                                (w *= v),
                                (w *= m),
                        ...
                        for (var o = 0; o < s.length; o++) {
                            ...
                            for (var u = 0; u < c.length; u++) {
                                ...
                                this.metadata[i][a][l] == null
                                    ...
                                    : (this.metadata[i][a][l] = this.metadata[i][a][l].concat(e.metadata[i][a][l]))
                            }
                        }
                    }
                }),
        ...
        return t.map((i, s) => {
            ...
            for (let [c, u] of o) {
                ...
                for (let x of u.sort((d, y) => y - d)) {
                    let d = (l[x] >>> 12) - g,
                        y = ((l[x] >>> 2) & 1023) + d
                    m = [m.slice(0, d), "<mark>", m.slice(d, y), "</mark>", m.slice(y)].join("")
                }
                if (a.push(m) === 2) break
            }
            return a.join("")
    ...
    function ae(t, e = r => r) {
        return t
            .trim()
            .split(/"([^"]+)"/g)
            .map((r, n) => (n & 1 ? r.replace(/^\b|^(?![^\x00-\x7F]|$)|\s+/g, " +") : r))
            .join("")
            .replace(/"|(?:^|\s+)[*+\-:^~]+(?=\s+|$)/g, "")
            .split(/\s+/g)
            .flatMap(e)
    ...
    function ce(t) {
        ...
        for (let n of e.clauses)
            (n.usePipeline = !0),
                n.term.startsWith("*") && ((n.wildcard = lunr.Query.wildcard.LEADING), (n.term = n.term.slice(1))),
                n.term.endsWith("*") && ((n.wildcard = lunr.Query.wildcard.TRAILING), (n.term = n.term.slice(0, -1)))
        return e.clauses
    }
    function le(t, e) {
        var i
            ...
            ;(this.map = ne(r)),
                ...
                (this.index = lunr(function () {
                    ...
                    for (let o of e.lang.map(a => (a === "en" ? lunr : lunr[a])))
                        for (let a of s) this.pipeline.remove(o[a]), this.searchPipeline.remove(o[a])
                    this.ref("location"),
                ...
                n = this.index
                    ...
                    .reduce((s, { ref: o, score: a, matchData: c }) => {
                        ...
                        if (typeof u != "undefined") {
                            ...
                            let g = +!u.parent + Object.values(l).filter(f => f).length / Object.keys(l).length
