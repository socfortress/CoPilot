...
def upgrade() -> None:
    ...
    op.create_table('available_network_connectors',
    ...
    op.create_table('customer_network_connectors',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('customer_network_connectors_meta',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('customer_code', sa.String(length=50), nullable=False),
    sa.Column('network_connector_name', sa.String(length=255), nullable=False),
    ...
    op.create_table('network_connectors_services',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['network_connector_service_id'], ['network_connectors_services.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('network_connectors_subscriptions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('customer_id', sa.Integer(), nullable=True),
    sa.Column('network_connectors_service_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['customer_id'], ['customer_network_connectors.id'], ),
    sa.ForeignKeyConstraint(['network_connectors_service_id'], ['network_connectors_services.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
