    ...
    <div class="flex items-start justify-between">
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-grow">
          ...
          <!-- View Mode -->
          <div v-else class="text-sm text-gray-700 whitespace-pre-wrap">{{ comment.comment }}</div>
        </div>
      </div>

      <!-- Actions -->
      <div v-if="canEdit && !isEditing" class="flex items-center space-x-1 ml-2">
        <button
          @click="startEdit"
        ...
        <button
          @click="confirmDelete"
          class="p-1 text-gray-400 hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 rounded"
