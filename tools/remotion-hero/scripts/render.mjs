...
const outPath = path.join(outDir, `copilot-hub.${format}`);

const tmpDir = path.join(os.tmpdir(), 'copilot-remotion-bundle');
...
// Resolve composition metadata (duration, fps, etc.)
