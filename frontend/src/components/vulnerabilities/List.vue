...
function getList() {
	...
	const query: VulnerabilitySearchQuery = {
		...
		customer_codes: (filters.value.find(o => o.type === "customer_codes")?.value as string[]) || undefined,
		severity: (filters.value.find(o => o.type === "severity")?.value as VulnerabilitySeverity) || undefined,
		cve_id: (filters.value.find(o => o.type === "cve_id")?.value as string) || undefined,
		agent_name: (filters.value.find(o => o.type === "agent_name")?.value as string) || undefined,
		package_name: (filters.value.find(o => o.type === "package_name")?.value as string) || undefined,
		include_epss: true
	}
