<template>
	<div class="flex flex-col gap-4">
		...
		<!-- Statistics Cards -->
		<div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
			<div class="stat-card">
			...
			<div
				class="stat-card critical clickable"
				:class="{ selected: selectedSeverity === VulnerabilitySeverity.Critical }"
				@click="selectSeverity(VulnerabilitySeverity.Critical)"
			>
				<div class="stat-header">
			...
			<div
				class="stat-card high clickable"
				:class="{ selected: selectedSeverity === VulnerabilitySeverity.High }"
				@click="selectSeverity(VulnerabilitySeverity.High)"
			>
				<div class="stat-header">
			...
			<div
				...
				:class="{ selected: selectedSeverity === VulnerabilitySeverity.Medium }"
				@click="selectSeverity(VulnerabilitySeverity.Medium)"
			>
				<div class="stat-header">
			...
			<div
				class="stat-card low clickable"
				:class="{ selected: selectedSeverity === VulnerabilitySeverity.Low }"
				@click="selectSeverity(VulnerabilitySeverity.Low)"
			>
				<div class="stat-header">
		...
		<VulnerabilityStats :filters @update:severity="selectSeverity" @update:package="selectPackage" />
		...
		<n-spin :show="loading">
			<div class="my-3">
				<div v-if="list.length" class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
					<VulnerabilityCard
						v-for="item of list"
						:key="`${item.cve_id}-${item.agent_name}`"
						:vulnerability="item"
					/>
				</div>
				<template v-else>
...
const searchPackage = ref<string | null>(null)
