        ...
        <div v-if="rule" class="flex flex-col gap-4">
            ...
            >
                ...
                <n-form-item label="Alert Title" path="custom_title">
                    <n-input
                        v-model:value="formValue.custom_title"
                ...
                <n-form-item label="Event Limit" path="event_limit">
                    <n-input-number
                        v-model:value="formValue.event_limit"
                        :min="1"
                        :max="10000"
                        class="w-full"
                    />
                    <template #feedback>
                        <span class="text-xs opacity-60">
                            Maximum number of events to process per execution
                        </span>
                    </template>
                </n-form-item>
                ...
                <n-form-item label="Streams" path="streams">
                    ...
                    <template #feedback>
                        <span class="text-xs opacity-60">
                            Optional: Limit search to specific Graylog stream IDs
                        </span>
                    </template>
                </n-form-item>
            </n-form>
