<template>
	...
	>
		<header
			class="border-default flex flex-wrap items-center gap-2 border-b bg-[rgba(var(--warning-color-rgb)/0.08)] px-3 py-2.25"
		>
			...
			<code
				class="text-warning text-2xs ms-auto rounded-sm bg-[rgba(var(--warning-color-rgb)/0.12)] px-2 py-0.5 font-mono"
			>
		...
		<div class="flex flex-col gap-5 p-3">
			...
			<div class="flex flex-wrap gap-2.5">
				<div
					class="border-default bg-secondary flex min-w-38 flex-1 flex-col gap-0.25 rounded-sm border px-3 py-2.5"
				>
