import {
	...
	AlertSourceDataKind,
	AlertSourceDataLevelEnum,
	AlertSourceDataLogsourceCategory,
	AlertSourceDataLogsourceProduct,
	AlertSourceDataStatus,
	AlertSourceDataWinEventdataIntegrityLevel,
	AlertSourceDataWinSystemSeverityValue,
		...
		alerts: [
			{
				...
				_source: {
					...
					syslog_type: AlertSourceSyslogType.Wazuh,
					syslog_level: AlertSourceSyslogLevel.Alert,
					...
					decoder_name: AlertSourceDecoderName.WindowsEventchannel,
					...
					data_win_system_severityValue: AlertSourceDataWinSystemSeverityValue.Information,
					...
					rule_group3: AlertSourceDataLogsourceProduct.Windows,
		...
		alerts: [
			{
				...
				_source: {
					...
					decoder_name: AlertSourceDecoderName.JSON,
		...
		alerts: [
			{
				...
				_source: {
					...
					gl2_source_input: "6459151dea00fd5d3da2df91",
					rule_level: 12,
					data_level: AlertSourceDataLevelEnum.High,
					...
					data_status: AlertSourceDataStatus.Experimental,
					...
					data_source: AlertSourceDataLogsourceProduct.Sigma,
					...
					data_event_RuleName: "-",
					data_logsource_category: AlertSourceDataLogsourceCategory.FileEvent,
					...
					data_group: AlertSourceDataGroup.Sigma,
					rule_firedtimes: 1,
					...
					data_kind: AlertSourceDataKind.Individual,
					data_logsource_product: AlertSourceDataLogsourceProduct.Windows,
					...
					rule_group3: AlertSourceDataLogsourceProduct.Sigma,
		...
		alerts: [
			{
				...
				_source: {
					...
					data_win_eventdata_integrityLevel: AlertSourceDataWinEventdataIntegrityLevel.System,
			...
			},
			{
				...
				_source: {
					...
					process_id: "3772",
					data_win_system_severityValue: AlertSourceDataWinSystemSeverityValue.Warning,
					rule_gdpr: "IV_35.7.d",
					rule_firedtimes: 1,
...
export const alerts_by_rule_per_host = [
	{
		agent_name: "ANSYDWDC01",
		number_of_alerts: 20,
		rule: "Process Explorer Driver Creation By Non-Sysinternals Binary"
