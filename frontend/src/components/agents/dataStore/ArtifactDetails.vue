<template>
    <div class="artifact-details flex flex-col gap-4">
        <n-descriptions :column="1" bordered size="small">
            ...
            <n-descriptions-item label="Customer Code" v-if="artifact.customer_code">
            ...
            <n-descriptions-item label="Uploaded By" v-if="artifact.uploaded_by">
                {{ artifact.uploaded_by }}
            </n-descriptions-item>
            <n-descriptions-item label="Notes" v-if="artifact.notes">
                {{ artifact.notes }}
            </n-descriptions-item>
        </n-descriptions>
    </div>
